...
export default function LoginPage() {
  return (
    <PublicPageShell>
      <ContentPage eyebrow="Portal" title="Portal access" intro="Public customer login is not currently advertised on this website. Agent access is available through the Xogmall Agent Portal.">
        <p>Authorised Xogmall staff can manage website updates by visiting <code className="rounded bg-sky-soft px-2 py-1 font-mono text-sm text-ink">/admin</code>.</p>
        {AGENT_PORTAL_URL ? (
