  ...
  return (
    <PublicPageShell>
      <ContentPage eyebrow="Legal placeholder" title="Privacy Policy" intro={launchPlaceholder}>
        <p>This page is a non-operative placeholder. It must be replaced with an approved Hogmall privacy notice before any personal information is collected in production.</p>
