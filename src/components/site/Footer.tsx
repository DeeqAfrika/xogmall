  ...
  return (
    <footer className="bg-navy text-white">
      <div className="container-shell grid gap-10 py-12 sm:grid-cols-2 lg:grid-cols-[1.35fr_0.7fr_0.7fr_0.8fr]">
        <div>
          <Image src={brand.logo.white} alt={brand.name} width={1774} height={887} className="h-auto w-[132px]" />
          <p className="mt-5 max-w-sm text-xs leading-6 text-blue-100">Public rate information, agent discovery, and agent onboarding.</p>
          <p className="mt-4 max-w-sm text-[11px] leading-5 text-blue-200">Registered address and contact details: to be confirmed before launch.</p>
        </div>
        <div>
          <h3 className="text-xs font-bold uppercase tracking-wider">Pages</h3>
          <div className="mt-4 flex flex-col gap-2.5 text-xs text-blue-100">
      ...
      <div className="border-t border-white/10">
        <div className="container-shell flex flex-col gap-3 py-5 text-[10px] leading-5 text-blue-200 sm:flex-row sm:items-center sm:justify-between">
